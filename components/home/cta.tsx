        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div className="md:w-2/3">
            ...
            <p className="mt-4 text-lg max-w-3xl">
              Свяжитесь с нами для бесплатной консультации. Наши специалисты готовы помочь вам решить проблему с автосалоном, СТО или производителем.
            </p>
          </div>
          <div className="mt-6 md:mt-0 space-y-4 md:space-y-0 md:space-x-4 flex flex-col md:flex-row items-start md:items-center">
            <a href="tel:+375293948416">
