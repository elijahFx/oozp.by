      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <p className="lead text-xl text-muted-foreground">
            Общественное объединение по защите прав потребителей "Автопотребитель" — некоммерческое общественное объединение, защищающее права и интересы потребителей во всех сферах потребительского рынка в Беларуси.
          </p>
          
          <h2 className="text-2xl font-semibold mt-8 mb-4">Наша миссия</h2>
          <p>
            Мы стремимся создать справедливый потребительский рынок, где права потребителей уважаются и соблюдаются, а споры разрешаются цивилизованным путем на основе законодательства о защите прав потребителей.
          </p>
          ...
          <p>
            Общественное объединение было создано группой юристов и активистов, столкнувшихся с систематическими нарушениями прав потребителей. За годы работы мы помогли сотням граждан Беларуси отстоять свои права и получить компенсацию за некачественные товары и услуги.
          </p>
          ...
          <p>
            Мы открыты для сотрудничества с государственными органами, другими общественными объединениями и СМИ по вопросам защиты прав потребителей во всех сферах и повышения правовой грамотности населения.
          </p>
        </div>
      </div>
    </div>
