      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <p className="lead text-xl text-muted-foreground">
            Общественное объединение "Автопотребитель" — некоммерческая организация, защищающая права и интересы потребителей во всех сферах потребительского рынка в Беларуси.
          </p>
          ...
          <p>
            Объединение было создано группой юристов и активистов, столкнувшихся с систематическими нарушениями прав потребителей. За годы работы мы помогли сотням граждан Беларуси отстоять свои права и получить компенсацию за некачественные товары и услуги.
          </p>
