...
export const metadata: Metadata = {
  title: "Порядок обращений | Автопотребитель - защита прав потребителей",
  description: "Пошаговая инструкция по защите прав потребителей в Беларуси. Алгоритм действий при нарушении прав, составление претензии, обращение в суд по всем категориям товаров и услуг.",
  keywords: "порядок обращений, защита прав потребителей, претензия, юридическая помощь, нарушение прав потребителей, исковое заявление, компенсация, потребительский рынок",
  openGraph: {
    title: "Порядок обращений для потребителей | Автопотребитель",
    description: "Пошаговый алгоритм действий при нарушении прав потребителей. Консультации, составление претензий, судебная защита по всем сферам потребительского рынка.",
    type: "website",
    locale: "ru_BY",
  },
};
